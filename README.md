...
And see https://github.com/luxonis/depthai-experiments/tree/depthai-experiments-spi/gen2-spi for pulling off JPEG and/or depth (including cropping on DepthAI) instead of the MobileNetv2-SSD or tinyYOLOv3 metadata shown below.
